...
def call_train():
    ...
    parser.add_argument("-mode", default='test_text',
                        type=str, choices=['test_text'])
    ...
    parser.add_argument("-large", type=str2bool, nargs='?',
